...
BLFS_SECTION=blfs-genutils
BLFS_SOURCE_FILE_PREFIX=time
...
time {
	...
	make $BLFS_MAKE_FLAGS &> $BLFS_LOG_FILE-2-make.log
	...
	make install $BLFS_MAKE_FLAGS &> $BLFS_LOG_FILE-3-make-install.log
